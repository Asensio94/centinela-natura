...
<section class="metodo" id="metodo">
  <div>
    ...
    <p>Para cada alerta nueva se busca la escena despejada más verde de antes y la más verde de después, su mejor momento, que es lo que compara el detector, se publican las dos y con sus bandas se decide el tipo: agua, quemado, suelo desnudo, superficie oscura o pérdida de vegetación sin más. Son reglas con umbrales publicados en la literatura. No interviene ningún modelo entrenado ni ninguna inteligencia artificial, y cualquier alerta se puede rehacer a mano desde las imágenes.</p>
    ...
    <p><strong>Provisional</strong>: visto una vez. <strong>Confirmada</strong>: sigue ahí en la ventana de un mes posterior. <strong>Descartada</strong>: la vegetación volvió antes de confirmarse, no se volvió a ver, o era agua nueva sobre lo que ya era agua (el nivel de un embalse). <strong>Revertida</strong>: volvió después.</p>
  </div>
  <div>
    <h2>Parámetros</h2>
    __METODO__
